...
@Component({
  selector: 'ngx-order-select-orthodontic-colours',
  templateUrl: './order-select-orthodontic-colours.component.html',
  styleUrls: ['./order-select-orthodontic-colours.component.scss'],
})

export class OrderSelectOrthodonticColoursComponent implements OnInit {
  @Input() value: any;
  @Input() arch: any;
  @Input() product: any;
  @Input() disabled: any;
  ...
  ngOnInit() {
    if (this.product.orderProductColor?.id) {
      ...
      this.orderProductColorModel.orderProductId = this.product.id;
      this.orderProductColorModel.upperColorCount = this.product.product?.orthoColours;
      this.orderProductColorModel.lowerColorCount = this.product.product?.orthoColours;
    }
